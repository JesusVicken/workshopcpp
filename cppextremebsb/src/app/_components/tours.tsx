    ...
    <section className="bg-black py-24 px-4 md:px-6 border-t border-white/10">
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="grid md:grid-cols-2 gap-4 lg:gap-8 min-h-[800px]">
          ...
          <div className="group relative rounded-[2rem] overflow-hidden border border-white/10 bg-zinc-900 h-full min-h-[650px] md:min-h-full transition-all duration-500 hover:border-white/40">
            ...
            <div className="relative z-10 h-full flex flex-col justify-between p-8 md:p-10">
              ...
              <div>
                ...
                <div className="bg-zinc-950/80 backdrop-blur-md p-6 rounded-xl border-l-2 border-white/30 group-hover:border-white transition-all">
                  <h4 className="text-white font-bold uppercase mb-4 tracking-widest text-xs border-b border-white/10 pb-2">
                    Módulo 01
                  </h4>
                  <ul className="space-y-3">
                    {[
                      "Evolução técnica (Anos 70 - Hoje)",
                      "Biomecânica vs Força Bruta",
                      "Técnica Tahitiana vs Havaiana",
                      "Huti pa'ari, Huti pe'e, Tatara",
                      "Bioquímica da respiração",
                      "Remada em condições adversas",
          ...
          <div className="group relative rounded-[2rem] overflow-hidden border border-white/10 bg-zinc-900 h-full min-h-[650px] md:min-h-full transition-all duration-500 hover:border-white/40">
            ...
            <div className="relative z-10 h-full flex flex-col justify-between p-8 md:p-10">
              ...
              <div>
                <h3 className="text-5xl lg:text-7xl font-black text-white uppercase leading-[0.85] mb-6 tracking-tighter">
                  Leme <br />
                  <span className="text-transparent bg-clip-text bg-gradient-to-r from-gray-200 to-gray-600">Pro</span>
                </h3>
                ...
                <div className="bg-zinc-950/80 backdrop-blur-md p-6 rounded-xl border-l-2 border-white/30 group-hover:border-white transition-all">
                  ...
                  <ul className="space-y-3">
                    {[
                      ...
                      "Leme em Faca (Aquática/Aérea)",
                      "Correções: 45º e Lateral",
                      "Sinergia Barco x Mar",
